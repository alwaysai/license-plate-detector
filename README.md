...
If you'd like to build your own license plate tracker from scratch, fill out this [survey](https://alwaysai.surveykiwi.com/model-training-signup) and download the ready made [dataset](https://www.alwaysai.co/docs/_static/beta/dataset_sample_592.zip) to begin training your own license plate detection model. Then test out your model with your new app!
